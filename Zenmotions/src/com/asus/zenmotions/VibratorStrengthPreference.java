 ...
 * Copyright (C) 2019 ATechnoHazard
...
public class VibratorStrengthPreference extends Preference implements
    ...
    private static final String FILE_LEVEL = "/sys/class/timed_output/vibrator/vmax_mv";
    ...
    // Adapt to use non AppCompat libraries
    @Override
    ...
    private void setValue(String newValue, boolean withFeedback) {
        ...
        editor.putString(zenmotions.KEY_VIBSTRENGTH, newValue);
        editor.commit();
        if (withFeedback) {
    ...
    public static void restore(Context context) {
        ...
        String storedValue = PreferenceManager.getDefaultSharedPreferences(context).getString(zenmotions.KEY_VIBSTRENGTH, "3596");
